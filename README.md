...
Logs into Zerodha, screenshots your portfolio pages, compiles them into a PDF, and emails it to the configured Email address.
...
The browser opens for you to login to Zerodha Kite with the Credentials. Once you press **Enter**, it takes screenshots, compiles the PDF, and asks for confirmation before sending the email.
